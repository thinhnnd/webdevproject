...
$(document).ready(() =>{
    ...
    var pic3 = new Image();
    var pic4 = new Image();
    pic.src="./assets/img/backgrounds-wraper/bg-02-hoa-sen.jpg";
    pic2.src="./assets/img/backgrounds-wraper/bia1_QBQI.jpg";
    pic3.src="./assets/img/backgrounds-wraper/hoang-thanh-thang-long-04.jpg'";
    pic4.src= "./assets/img/backgrounds-wraper/bg-01-khue-van-cac-3.jpg";
