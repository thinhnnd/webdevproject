...
let bgLink = [
    ...
    "linear-gradient(to bottom right,rgba(0,47,75,0.7),rgba(220,66,37,0.7)), url('/assets/img/backgrounds-wraper/hoang-thanh-thang-long-02.jpg') center no-repeat",
    "linear-gradient(to bottom right,rgba(0,47,75,0.7),rgba(220,66,37,0.7)), url('/assets/img/backgrounds-wraper/bg-01-khue-van-cac.jpg') center no-repeat",
]
